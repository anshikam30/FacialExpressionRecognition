...
imwrite(I,'E:\Matlab\GCapsNet Multi-Feature Aware Pose and Geometry based Facial Expression Recognition using Deep Learning\Code\Proposed - GCapsNet\TrainImages\final.png')
figure
...
imshow(imgFace,'InitialMagnification',100); hold on;
